                ...
                @foreach($data as $key => $d)
                    <tr>
                      ...
                      <td style="line-height: 65px">
                        ...
                        <a href="{{ route('deleteclient',$d->id) }}"  class="btn btn-danger btn-sm delete"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                @endforeach
                </tfoot>
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            ...
            <div class="modal-body">
              <form action="{{ route('storeclient') }}" enctype='multipart/form-data' method="post">
                {{csrf_field()}}
                <div class="row">
      ...
      <div class="modal fade" id="modal-update">
        <div class="modal-dialog">
          <div class="modal-content bg-info">
            <div class="modal-header">
              <h4 class="modal-title">تعديل عميل : <span class="item_name"></span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
