          ...
          <div class="card-body">
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
               ...
               {{-- about app --}}
			   <li class="nav-item">
                <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-why_us" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">لماذا مُلتقي</a>
              </li>
								...
								<div class="card-header">
				              	...
				              	<div class="card-body">
									<form action="{{route('updatemainsetting')}}" method="post">
										...
										<div class="form-group row">
											<div class="col-lg-4">
												<label class="control-label"> الضريبة المُضافة :</label>
											</div>
											<div class="col-lg-8">
							                    <input type="number" name="tax_rate" class="form-control" step="any" value="{{$setting->tax_rate}}" required>
											</div>
										</div>
							...
							<div class="card-body">
							  <form action="{{route('updatewhyus')}}" method="post">
								  ...
								  <div class="row">
									  ...
									  <div class="col-sm-6">
										  <div class="form-group">
											  <label for="exampleInputCopyrightAr">لماذا مُلتقي بالعربية</label>
									  ...
									  <div class="col-sm-6">
										  <div class="form-group">
											  <label for="exampleInputCopyrightEn">لماذا مُلتقي بالإنجليزية</label>
				...
				<div class="row" style="margin-top: 10px">
					...
					<div class="col-md-12">
						<div class="panel-body">
							<div class="card card-primary card-outline">
								<div class="card-header">
								<h5 class="m-0" style="display: inline;"> قائمة  مواقع التواصل </h5>
