...
$(function() {
    ...
    $('.daterange-predefined').daterangepicker(
        ...
        function(start, end) {
            $('.daterange-predefined span').html(end.format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + start.format('MMMM D, YYYY'));
            $.jGrowl('Date range has been changed', { header: 'Update', theme: 'bg-primary', position: 'center', life: 1500 });
        }
    );

    // Display date format
    $('.daterange-predefined span').html(moment().format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + moment().subtract('days', 29).format('MMMM D, YYYY'));
    ...
    $('.daterange-ranges').daterangepicker(
        ...
        function(start, end) {
            $('.daterange-ranges span').html(end.format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + start.format('MMMM D, YYYY'));
        }
    );

    // Display date format
    $('.daterange-ranges span').html(moment().format('MMMM D, YYYY') + ' &nbsp; - &nbsp; ' + moment().subtract('days', 29).format('MMMM D, YYYY'));
