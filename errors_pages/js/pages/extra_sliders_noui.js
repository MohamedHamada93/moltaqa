...
$(function() {
    ...
    // Create sliders. All options are sadly dublicated because of a minor bug
    // in RTL direction
    noUiSlider.create(color1, {
        start: [2, 8],
        connect: true,
        direction: 'rtl',
        range: {
    ...
    noUiSlider.create(default_size2, {
        start: [2, 8],
        connect: true,
        direction: 'rtl',
        range: {
    ...
    noUiSlider.create(default_size3, {
        start: [2, 8],
        connect: true,
        direction: 'rtl',
        range: {
    ...
    noUiSlider.create(default_size4, {
        start: [2, 8],
        connect: true,
        direction: 'rtl',
        range: {
