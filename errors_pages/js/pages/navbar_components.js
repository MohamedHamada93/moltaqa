...
$(function() {
    ...
    $('.daterange-ranges-button').daterangepicker(
        ...
        function(start, end) {
            $('.daterange-ranges-button span').html(end.format('MMM D, YY') + ' - ' + start.format('MMM D, YY'));
        }
    );

    // Format results
    $('.daterange-ranges-button span').html(moment().format('MMM D, YY') + ' - ' + moment().subtract('days', 29).format('MMM D, YY'));
    ...
    $('.daterange-ranges').daterangepicker(
        ...
        function(start, end) {
            $('.daterange-ranges span').html(end.format('MMM D, YY') + ' - ' + start.format('MMM D, YY'));
        }
    );

    // Format results
    $('.daterange-ranges span').html(moment().format('MMM D, YY') + ' - ' + moment().subtract('days', 29).format('MMM D, YY'));
