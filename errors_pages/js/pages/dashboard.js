                    ...
                    .on("mousemove", function (d, i) {
                        ...
                        tooltip.html(
                            "<ul class='list-unstyled mb-5'>" +
                                "<li>" + "<div class='text-size-base mt-5 mb-5'><i class='icon-circle-right2 position-left'></i>" + d.key + "</div>" + "</li>" +
        ...
        var tooltip = d3.tip()
            ...
            .html(function (d) {
                return "<ul class='list-unstyled mb-5'>" +
                    "<li>" + "<div class='text-size-base mt-5 mb-5'><i class='icon-circle-right2 position-left'></i>" + d.name + " app" + "</div>" + "</li>" +
    ...
    function salesHeatmap() {
        ...
        d3.csv("assets/demo_data/dashboard/app_sales_heatmap.csv", function(error, data) {
            ...
            var legend = legendGroup.selectAll(".heatmap-legend")
                .data([0].concat(colorScale.range(colors.reverse()).quantiles()), function(d) { return d; })
                .enter()
                .append("g")
            ...
            function resizeHeatmap() {
                ...
                svg.selectAll('.min-legend-value')
                    .attr("x", (buckets * gridSize) + 10);
            }
        });
    }
    ...
    function bulletChart(element, height) {
        ...
        d3.json("assets/demo_data/dashboard/bullets.json", function(error, data) {
            ...
            function bulletResize() {
                ...
                // Title
                svg.selectAll('.bullet-title').attr("x", width);
            }
        });
