...
$(function() {
    ...
    $('#pnotify-styled-left').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left alert-styled-left',
            stack: stack_top_left,
            type: 'info'
        });
    });
    ...
    $('#pnotify-styled-right').on('click', function () {
        new PNotify({
            title: 'Error notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left alert-styled-right',
            stack: stack_top_left,
            type: 'error'
        });
    });
    ...
    $('#pnotify-styled-arrow').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left alert-styled-left alert-arrow-left text-sky-royal',
            stack: stack_top_left,
            type: 'info'
        });
    });
    ...
    $('#pnotify-custom-styled').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left alert-styled-left alert-styled-custom alert-arrow-left alpha-teal text-teal-800',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-warning').on('click', function () {
        new PNotify({
            title: 'Warning notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left bg-warning',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-info').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left bg-info',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-custom').on('click', function () {
        new PNotify({
            title: 'Custom notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left bg-teal',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-solid-styled-left').on('click', function () {
        new PNotify({
            title: 'Info notice',
            text: 'Check me out! I\'m a notice.',
            addclass: 'stack-top-left bg-primary alert-styled-left',
            stack: stack_top_left
        });
    });
    ...
    $('#pnotify-form').on('click', function () {
        var notice = new PNotify({
            ...
            width: '300px',
            hide: false,
            addclass: 'stack-top-left bg-slate',
            buttons: {
                closer: false,
                sticker: false
            },
    ...
    $('#pnotify-switching').on('click', function () {
        new PNotify({
            ...
            addclass: 'stack-top-left bg-primary alert-styled-right',
                ...
                PNotify.update({
                    ...
                    before_close: function(PNotify) {
                        PNotify.update({
                            ...
                            addclass: 'stack-top-left bg-success alert-styled-right',
                            stack: stack_top_left,
                            type: 'success',
                            before_close: function(PNotify) {
                                PNotify.update({
                                    ...
                                    addclass: 'stack-top-left bg-info alert-styled-right',
                                    stack: stack_top_left,
                                    type: 'info',
                                    before_close: null
                                });
    ...
    $('#pnotify-dynamic').on('click', function () {
        ...
        var interval = setInterval(function() {
            ...
            if (percent >= 100) {
                ...
                options.title = "Done!";
                options.addclass = "stack-top-left bg-success";
